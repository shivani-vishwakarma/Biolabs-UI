...
export class ResidentManagementComponent implements OnInit {
  ...
  async onSubmit() {
    ...
    if (this.selectedData && this.selectedData.id) {
      ...
      response.then(data => {
        ...
        this.getUserList();
        this.loading = false;
        this.toastr.success(CONFIG.SUCCESS_MSG.UPDATE_RESIDENT, '', {
          timeOut: 3000,
          closeButton: true
        });
        this.modalService.dismissAll();
        ...
        this.loading = false;
        // this.modalService.dismissAll()
        this.toastr.error(error ? error.message : CONFIG.ERROR_MSG.UPDATE_RESIDENT, '', {
          timeOut: 3000,
          closeButton: true
        });
      });
      ...
      response.then(data => {
        this.getUserList();
        this.loading = false;
        this.toastr.success(CONFIG.SUCCESS_MSG.ADD_RESIDENT, '', {
          timeOut: 3000,
          closeButton: true
        });
        this.modalService.dismissAll();
        ...
        this.loading = false;
        // this.modalService.dismissAll()
        this.toastr.error(error ? error.message : CONFIG.ERROR_MSG.ADD_RESIDENT, '', {
          timeOut: 3000,
          closeButton: true
        });
      });
  ...
  async deleteUserData(): Promise<any> {
    ...
    response.then(data => {
      this.getUserList();
      this.loading = false;
      this.toastr.success(CONFIG.SUCCESS_MSG.DELETE_RESIDENT, '', {
        timeOut: 3000,
        closeButton: true
      });
      this.modalService.dismissAll();
      ...
      this.getUserList();
      this.loading = false;
      this.toastr.error(error ? error.message : CONFIG.ERROR_MSG.DELETE_RESIDENT, '', {
        timeOut: 3000,
        closeButton: true
      });
    });
